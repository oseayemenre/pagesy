...
type Store interface {
	...
	GetBooksByGenre(ctx context.Context, genre []string, offset int, limit int, sort string) ([]models.Book, error)
	GetBooksByLanguage(ctx context.Context, language []string, offset int, limit int, sort string) ([]models.Book, error)
	GetBooksByGenreAndLanguage(ctx context.Context, genre []string, language []string, offset int, limit int, sort string) ([]models.Book, error)
	GetAllBooks(ctx context.Context, offset int, limit int, sort string) ([]models.Book, error)
